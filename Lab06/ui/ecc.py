...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_info.setGeometry(QtCore.QRect(110, 100, 611, 151))
        self.txt_info.setObjectName("txt_info")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(110, 270, 611, 151))
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(300, 20, 151, 31))
        self.btn_gen_keys.setObjectName("btn_gen_keys")
        self.btn_sign = QtWidgets.QToolButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(230, 450, 101, 31))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QToolButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(490, 450, 101, 31))
